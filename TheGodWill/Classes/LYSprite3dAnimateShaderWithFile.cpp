//
//  LYSprite3dAnimateShaderWithFile.cpp
//  WarOfGod
//
...
void CSprite3dAnimateShaderWithFile::setTarget(cocos2d::Sprite3D *target,std::string shaderFilePath,std::string glProgramKey){
...
//    auto glprogram = GLProgram::createWithFilenames("Sprite3DTest/fish/UVAnimation.vsh", "Sprite3DTest/fish/addColor.fsh");
    // ”…ShaderŒƒº˛¥¥Ω®’‚∏ˆShader
    ...
    if (glProgramKey!="") {
        ...
        glprogram = GLProgram::createWithFilenames("Sprite3DTest/fish/UVAnimation.vsh", "Sprite3DTest/fish/addColor.fsh");
    }
    
//    auto glprogram = GLProgramCache::getInstance()->getGLProgram("shaderFade");
...
//    auto textrue2 = Director::getInstance()->getTextureCache()->addImage("Sprite3DTest/caustics.png");
    ...
    schedule(schedule_selector(CSprite3dAnimateShaderWithFile::cylinderUpdate));
...
void CSprite3dAnimateShaderWithFile::draw(Renderer* renderer, const Mat4 &transform, uint32_t flags)
{
    if(m_Sprite)
    {
...
void CSprite3dAnimateShaderWithFile::cylinderUpdate(float dt){
